...
const CreateNewWithNoHistory = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.setNotification(`a new anecdeote ${content} created!`)
...
const CreateNew = withRouter(CreateNewWithNoHistory)
  ...
  return (
    <Router>
      <div>
        ...
        <Route path="/create-new" render={() => <CreateNew addNew={addNew} setNotification={setNotification}/>}/>
